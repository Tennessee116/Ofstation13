/singleton/cultural_info/location/human
	...
	description = "A once thriving industrial world, Mars is a shadow of its former glory. \
	Following the workers revolt of 2314, and the Red Spring conflicts between Croatian Catholics and Muslim Albanians, \
	most Martian industrial production has ceased. The planet's economy is in free fall, \
	and its inhabitants either struggle in vain to seize their surplus value or choose to head to greener pastures."
...
/singleton/cultural_info/location/human/psyltosk
	...
	description = "Psyltosk, the capital world of the Tsardom of Psyltosk is a flat plain of steppes, deserts and calm seas. \
