...
/datum/pai_software/proc/on_ui_interact(mob/living/silicon/pai/user, datum/tgui/ui)
		return
...
/datum/pai_software/directives/on_ui_interact(mob/living/silicon/pai/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, user, ui)
	if(!ui)
		// Don't copy-paste this unless you're making a pAI software module!
		ui = new(user, user, "PaiDirectives")
		ui.open()

/datum/pai_software/directives/ui_data(mob/living/silicon/pai/user)
	var/data[0]
...
/datum/pai_software/radio_config/on_ui_interact(mob/living/silicon/pai/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, user, ui)
	if(!ui)
		ui = new(user, user, "PaiRadioConfig")
		ui.open()

/datum/pai_software/radio_config/ui_data(mob/living/silicon/pai/user)
	var/data[0]
...
/datum/pai_software/crew_manifest/on_ui_interact(mob/living/silicon/pai/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, user, ui)
	if(!ui)
		// Don't copy-paste this unless you're making a pAI software module!
		ui = new(user, user, "CrewManifest")
		ui.open()

/datum/pai_software/crew_manifest/ui_data(mob/user)
	var/data[0]
...
/datum/pai_software/door_jack/on_ui_interact(mob/living/silicon/pai/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, user, ui)
	if(!ui)
		// Don't copy-paste this unless you're making a pAI software module!
		ui = new(user, user, "PaiDoorjack")
		ui.open()

/datum/pai_software/door_jack/ui_data(mob/living/silicon/pai/user)
	var/data[0]
...
/datum/pai_software/atmosphere_sensor/on_ui_interact(mob/living/silicon/pai/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, user, ui)
	if(!ui)
		// Don't copy-paste this unless you're making a pAI software module!
		ui = new(user, user, "PaiAtmosphere")
		ui.open()

/datum/pai_software/atmosphere_sensor/ui_data(mob/user)
	var/data[0]
