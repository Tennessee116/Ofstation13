...
/obj/item/clothing/head/helmet/space
	...
	center_of_mass = null
	randpixel = 0
	species_restricted = list("exclude", SPECIES_XENO)
...
/obj/item/clothing/suit/space
	...
	icon_state = "space"
	item_icons = list(
		slot_l_hand_str = 'resources/icons/mob/onmob/items/lefthand_spacesuits.dmi',
		slot_r_hand_str = 'resources/icons/mob/onmob/items/righthand_spacesuits.dmi',
		)
	item_state_slots = list(
